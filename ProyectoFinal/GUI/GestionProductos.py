...
class GestionProductos(ctk.CTkToplevel):
    ...
    def agregar(self):
        ...
        boton_agregar = ctk.CTkButton(frame_botones, text='Agregar', font=('Arial', 20), fg_color='green', width= 180, height=40, command=lambda: self.guardarDatos(nombre_producto, precio_producto, descripcion_producto, stock, categoria))
